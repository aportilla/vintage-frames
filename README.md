...
| `DragController`, `ScrollStateController`, `TrackWidthController` | Pointer-drag wiring; per-axis overflow reporting for the always-a-rail scrollbars; a track's measured width, for drawing your own 1-bit fill on the system-pixel grid |

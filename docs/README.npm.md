...
[SPEC.md](https://github.com/aportilla/vintage-frames/blob/main/SPEC.md) —
which ships in this package — is the design spec: every token, slot, part and
event. [DESIGN-TOKENS.md](https://github.com/aportilla/vintage-frames/blob/main/DESIGN-TOKENS.md)
lists every `--vf-*` theming token with its default and what reads it.
...
Those subpaths and the root are the whole export surface. Bundled and minified
with `lit` external:
...
registration are module-scoped singletons.
...
The [full README on GitHub](https://github.com/aportilla/vintage-frames#readme)
...
pixel-for-pixel. The [GitHub README](https://github.com/aportilla/vintage-frames#readme)
